...
import embeddedImg from "../assets/Tech-embedded.jpg";
...
function Home() {
  ...
  const technologies = [
    { title: "VLSI Chip Design", img: vlsiImg, icon: Cpu, path: "/vlsipage" },
    { title: "Embedded &IoT", img: embeddedImg, icon: CircuitBoard, path: "/embeddediot" },
    { title: "Gen AI", img: edgeAiImg, icon: Brain, path: "/genaipage" },
    { title: "PCB", img: pcbimg, icon: Brain, path: "/pcbpage" },
    ...
    <>
      ...
      <section className="home">
        ...
        <div className="overlay-text">
          <div className="hero-badge">Advanced Semiconductor Systems</div>
          ...
          <div className="hero-tagline">
            Innovate <span>|</span> Integrate <span>|</span> Elevate
          </div>
